...
export type SiteSettings = {
  ...
  DocsSystemName: string
  DocsServerAddress: string
  DocsClientDownloadLink: string
  DocsDiscordLink: string
  DocsImgWalletEntry: string
  DocsImgOrderPage: string
  DocsImgCodeMessage: string
  DocsImgCodeExchange: string
  DocsImgDownloadRelease: string
  DocsImgOpenai1: string
  DocsImgOpenai2: string
  DocsImgOpenai3: string
  DocsImgOpenai4: string
  DocsImgOpenai5: string
  DocsImgClaude1: string
  DocsImgClaude2: string
  DocsImgModleAlias: string
  DocsImgClaude3: string
  DocsImgClaude5: string
  DocsImgClaude6: string
  DocsImgClaudeDesktop1: string
  DocsImgClaudeDesktop2: string
  DocsImgClaudeDesktop3: string
  DocsImgClaudeDesktop4: string
  DocsImgClaudeDesktop5: string
}
