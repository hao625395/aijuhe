...
const RechargeCard = ({
  ...
  const rechargePlans = [
    ...
    { value: 1000, title: '专业', subtitle: '专业开发者', badge: '最佳价值', featured: true },
      ...
      {rechargePlans.map((plan) => {
        ...
        return (
          ...
          >
            {plan.badge && (
              <div
                className='absolute left-3 top-3 rounded-full px-2.5 py-0.5 text-[11px] font-bold leading-5'
                style={{
                  color: plan.featured ? '#b45309' : '#92400e',
                  background: plan.featured ? '#fff7ed' : '#fffbeb',
                  border: `1px solid ${plan.featured ? '#fed7aa' : '#fde68a'}`,
                }}
              >
                {plan.badge}
              </div>
